# Generated by Powerlevel10k configuration wizard on 2023-04-24 at 11:01 BST.
...
() {
  ...
  # Hide Packer, SOPS and kubectl versions, these files probably won't exist
  typeset -g POWERLEVEL9K_ASDF_PACKER_SHOW_ON_UPGLOB='.packer-version'
  typeset -g POWERLEVEL9K_ASDF_SOPS_SHOW_ON_UPGLOB='.sops-version'
  typeset -g POWERLEVEL9K_ASDF_KUBECTL_SHOW_ON_UPGLOB='.kubectl-version'
